...
const Login = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-md mx-auto px-4 pt-20 md:pt-24 pb-18">
        <div
        ...
        >
          ...
          <h2
            className={`text-center text-2xl md:text-3xl font-['Fraunces'] font-black tracking-tight mb-3 ${theme === "dark" ? "text-white" : "text-slate-900"}`}
          >
            Login
          </h2>
